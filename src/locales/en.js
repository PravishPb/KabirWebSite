export default {
  ...
  "Gathering": {
    ...
    "items": [
      {
        "title": "Satsang",
        "description": "A weekly gathering centred on the teachings of Kabir. Through readings, reflection, and shared silence, we explore the path of truth together."
      },
      {
        "title": "Bhajan performances",
        "description": "Devotional singing that opens the heart. In the tradition of the nirgun saints, these songs carry the listener beyond words into direct experience."
      },
      {
        "title": "Yoga",
        "description": "Gentle practice rooted in classical tradition. We move, breathe, and still the body — preparing ourselves for the inner journey of meditation."
      }
    ]
  },
  "Hero": {
  ...
  "Navbar": {
    ...
    "newsDesc": "Stay updated with latest announcements",
  ...
  "QuoteSection": {
    ...
    "quote": "\"I went looking for the wicked, I found none. When I looked inside myself, I found none worse than me. Kabir says, the seeker of truth is the one who recognises their own ignorance and, with humility, seeks the company of the wise.\"",
    "breathe": "Breathe",
    "more": "More teachings"
  },
  "RitualFeature": {
  ...
  "EventsPage": {
    ...
    "noUpcomingEvents": "There are no upcoming events scheduled at this time.",
    "noEvents": "No events are currently scheduled or recorded. Please check back later.",
  ...
  "LoginPage": {
    ...
    "adminLoginSubtitle": "Sign in to manage the KAOT website",
  ...
  "AdminLayout": {
    ...
    "navNews": "News",
    "navMfa": "MFA Security",
    "navUsersSoon": "Users (Soon)",
    "navLibrarySoon": "Library (Soon)",
    "logout": "Logout",
    "viewLiveSite": "View Live Site",
    "logoutSuccess": "Logged out successfully",
    "logoutError": "Error logging out",
    "mfaTitle": "Two-Factor Authentication (MFA)",
    "mfaDesc": "Add an extra layer of security to your admin account by requiring a verification code from an authenticator app each time you sign in.",
    "mfaLoading": "Loading security settings...",
    "mfaScanTitle": "Scan the QR Code",
    "mfaScanInstructions": "Open your Google Authenticator or standard TOTP app (like Authy or 1Password), scan this QR code, and enter the 6-digit verification code below.",
    "mfaManualKey": "Manual Secret Key",
    "mfaVerificationLabel": "Verification Code",
    "mfaVerifyEnableBtn": "Verify and Enable",
    "mfaActivating": "Activating...",
    "mfaCancel": "Cancel",
    "mfaEnableSuccess": "Two-factor authentication successfully enabled!",
    "mfaEnterCodeAlert": "Please enter a 6-digit code",
    "mfaStatusActive": "MFA is Active",
    "mfaStatusActiveDesc": "Your account is protected by your password and an authenticator code.",
    "mfaDisableBtn": "Disable Two-Factor Authentication",
    "mfaConfirmDisableTitle": "Disable Two-Factor Authentication?",
    "mfaConfirmDisableDesc": "This will lower your account security. You will only need your email and password to sign in.",
    "mfaConfirmYesBtn": "Yes, Disable",
    "mfaStatusInactive": "MFA is Not Active",
    "mfaStatusInactiveDesc": "Your account is only protected by a password. Enable MFA to secure your dashboard.",
    "mfaEnableBtn": "Enable Two-Factor Authentication",
    "mfaInitializing": "Initializing...",
  ...
  "AdminEvents": {
    ...
    "labelImageUrl": "Event Image URL",
    "labelDescription": "Description",
    "btnCancel": "Cancel",
    "btnSaveChanges": "Save Changes",
    "btnCreateEvent": "Create Event",
    "modalDeleteTitle": "Delete Event",
    "modalDeleteDesc": "Are you sure you want to delete this event? This action cannot be undone.",
    "btnDelete": "Delete",
    "toastUpdateSuccess": "Event updated successfully",
    "toastUpdateError": "Error updating event",
    "toastCreateSuccess": "Event created successfully",
    "toastCreateError": "Error creating event",
    "toastDeleteSuccess": "Event deleted successfully",
    "toastDeleteError": "Error deleting event",
  ...
  "AdminBlogs": {
    ...
    "desc": "Create, edit, and delete public blog posts.",
    "createBlogBtn": "Create Blog",
    "thTitle": "Title",
    "thCategory": "Categories",
    "thAuthor": "Author",
    "thPublishedAt": "Published Date",
    "thActions": "Actions",
    "emptyMessage": "No blogs found. Create one to get started.",
    "loading": "Loading blogs...",
    "modalCreateTitle": "Create Blog",
    "modalEditTitle": "Edit Blog",
    "labelTitle": "Title",
    "labelAuthor": "Author",
    "labelCategories": "Categories (comma separated)",
    "labelImageUrl": "Featured Image URL",
    "labelExcerpt": "Excerpt",
    "labelContent": "Content (HTML allowed)",
    "labelSlug": "Slug (optional)",
    "labelPublishedAt": "Published At",
    "btnCancel": "Cancel",
    "btnSaveChanges": "Save Changes",
    "btnCreateBlog": "Create Blog",
    "modalDeleteTitle": "Delete Blog",
    "modalDeleteDesc": "Are you sure you want to delete this blog? This action cannot be undone.",
    "btnDelete": "Delete",
    "toastUpdateSuccess": "Blog updated successfully",
    "toastUpdateError": "Error updating blog",
    "toastCreateSuccess": "Blog created successfully",
  ...
  "NewsPage": {
    ...
    "intro": "Keep up with the latest updates, announcements, and news from our community.",
    "eyebrow": "Updates",
    "loading": "Loading news items...",
    "noNews": "No news or announcements recorded at this time. Please check back later.",
    "searchPlaceholder": "Search news by title or content...",
    "noMatchingNews": "No matching news items found.",
  ...
  "AdminNews": {
    ...
    "desc": "Create, edit, and delete news posts, updates, and announcements.",
    "createNewsBtn": "Add News Item",
    "searchPlaceholder": "Search news...",
    "emptyMessage": "No news items found. Add one to get started.",
    "noMatchingNews": "No matching news items found.",
    "loading": "Loading news database...",
    "modalCreateTitle": "Add News & Announcement",
    "modalEditTitle": "Edit News & Announcement",
    "labelTitle": "Title (Required)",
    "labelDate": "Publish Date (Required)",
    ...
    "labelSaving": "Saving...",
    "labelDeleting": "Deleting...",
    "modalDeleteTitle": "Delete News Item",
    "modalDeleteDesc": "Are you sure you want to delete this news item? This action is permanent.",
    "btnDelete": "Delete",
    "toastCreateSuccess": "News item created successfully!",
    "toastCreateError": "Failed to create news item.",
    "toastUpdateSuccess": "News item updated successfully!",
    "toastUpdateError": "Failed to update news item.",
    "toastDeleteSuccess": "News item deleted successfully!",
    "toastDeleteError": "Failed to delete news item.",
    "toastError": "An error occurred.",
    "locale": "en-US"
  }
};
